...
function signup() {
  ...
  return (
    <div className="d-flex flex-column justify-content-center align-items-center vh-100">
      <h1 className="text-light mb-5">Book your tickets now</h1>

      <form
        onSubmit={handleSubmit}
        className="bg-info bg-opacity-25 py-4 px-5 w-25 rounded-2"
      >
        <h2 className="text-info text-center mb-3">Sign Up</h2>
        ...
        {errors}
        <button className="btn btn-info text-light fw-semibold">Sign Up</button>
      </form>
    </div>
  );
}
